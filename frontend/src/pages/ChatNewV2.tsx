...
const ChatNewV2 = () => {
  ...
  return (
    <Layout>
      <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-[#060d1a] dark:via-[#060d1a] dark:to-[#060d1a] -mt-16 pt-24 pb-8">
        <div className="container mx-auto px-4 max-w-3xl flex-1 flex flex-col">
            ...
            <div className="inline-flex bg-gray-100 dark:bg-slate-800 rounded-xl p-1 gap-1">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                  mode === "chat"
                    ? "bg-white shadow-sm text-blue-700 border border-blue-100 dark:bg-slate-700 dark:text-blue-300 dark:border-slate-600"
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                  mode === "simulate"
                    ? "bg-white shadow-sm text-purple-700 border border-purple-100 dark:bg-slate-700 dark:text-purple-300 dark:border-slate-600"
                    : "text-gray-500 hover:text-gray-700 dark:text-slate-400 dark:hover:text-slate-200"
                }`}
              >
          ...
          {/* Chat window */}
          <div className="flex-1 flex flex-col rounded-2xl border-2 border-gray-200 bg-white shadow-xl hover:shadow-2xl transition-shadow duration-300 overflow-hidden dark:border-slate-700 dark:bg-slate-900">

            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-6 space-y-4 scrollbar-thin scrollbar-thumb-blue-200 dark:scrollbar-thumb-slate-600 scrollbar-track-gray-100 dark:scrollbar-track-slate-800">
                    ...
                    <div
                      className={`rounded-2xl px-4 py-3 ${
                        msg.sender === "user"
                          ...
                          : "bg-gray-100 text-foreground rounded-bl-none shadow-sm dark:bg-slate-800 dark:text-slate-100"
                      }`}
                    >
              ...
              {isLoading && (
                <div className="flex justify-start animate-fade-up">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="bg-gray-100 dark:bg-slate-800 rounded-2xl rounded-bl-none px-4 py-3 shadow-sm">
            ...
            {/* Input bar */}
            <div className="border-t border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900 p-4 flex-shrink-0">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all disabled:opacity-50 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                />
                <button
                  onClick={handleSend}
