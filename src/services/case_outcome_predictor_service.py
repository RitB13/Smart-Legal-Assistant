...
class CaseOutcomePredictorService:
    ...
    def compose_petition_text(
        ...
        prompt = (
            "You are a senior Indian advocate drafting a petition summary.\n"
            "Convert the information below into a concise legal summary (4–6 sentences) "
            "in formal Indian court petition language — the kind found in High Court and "
            "Supreme Court filings.\n"
            "Use phrases such as 'The petitioner submits that…', 'The respondent has failed…', "
            "'The petitioner seeks…', 'The matter involves…'.\n"
            "Do NOT invent facts. Use only what is provided. Write only the summary — "
            "no headings, no bullet points, no explanation.\n\n"
            f"Role of the person: {role_label}\n"
